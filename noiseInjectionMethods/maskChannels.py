...
def main(data_loader_dict, args, optim_config, cuda, writer, one_subject, seed=3):
    ...
    if args.dataset_name == 'seed3':
        ...
        iteration = 3
    acc = trainDMMR_Noise_MaskChannels(data_loader_dict, optim_config, cuda, args, iteration, writer, one_subject)
    return acc
...
if __name__ == '__main__':
    ...
    parser.add_argument("--index", type=str, default='maskChannels', help="tensorboard index")
